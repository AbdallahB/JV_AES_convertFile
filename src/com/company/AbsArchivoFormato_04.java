...
public class AbsArchivoFormato_04 extends AbsArchivo {
    public AbsArchivoFormato_04(String primeraPalabraValidaArchivo, int anumlineas, String sDirectorioTrabajo, String tipoFormatoaLeer, int numeroTotalDigitosNombreArchivoxtipoFormato) {
    ...
    public String generarTokensFormato_04(String path, String nombArch, int numlineas) throws IOException, ParseException {
        ...
        System.out.println("generarTokensFormato_04 Trifasico");
        ...
        try {
            ...
            while ((blinea = buffer.readLine()) != null) {
                ...
                if (indPosicion < lineasEncabezadoArchivo) {             //valor que delimita la lectura del encabezado
                   // System.out.println("contenido del encabezado, linea nro " + indPosicion + " contenido: " + blinea);//
                    ...
                    for (int encb = 0; encb < parts.length; encb++) {
                        ...
                        if (indPosicion==lineasEncabezadoArchivo-1 && encb==2){
                            ...
                            System.out.println("se asigna el multiplo de potencia con valor: "+multiploUnidadPotencia);
                        }
                  ...
                  // }
                    //-------------------------------------------------
                    // control digitos del año y flag de error de campos
                    // control digitos del año y flag de error de campos
...
//<<<<<<<<< ¡¡¡¡¡¡¡
                    ...
                    try {
                        ...
                        ex.printStackTrace();
                      //  JOptionPane.showMessageDialog(null, "catched "+parts[2]+" "+parts[3]);
                        FlagCamposBlineaError=true;
                    }
                    //---------------------
                    //*************************************************************************************************
                        ...
                        switch (m) {
                            case 0:
                                if (parts[m]==""||parts[m]==null||parts[m]==" "){
                                    JOptionPane.showMessageDialog(null, "Se encontró un error de formato en el archivo: "+nombArch );
                                }
        ...
        // Metodo para corregir la hora 24:00:00 por 00:00 y asignar fecha del dia siguiente
