...
public class AbsMedicionesFormato_03 extends AbsMediciones {
    ...
    public AbsMedicionesFormato_03(String tipodeFormatoaLeer, JFrame framePrincipal) {
        super(tipodeFormatoaLeer);
        this.framePrincipal = framePrincipal;
    }

    //---------------------------------------------------------------------------------
    public AbsMedicionesFormato_03(String tipodeFormatoaLeer) {
        super(tipodeFormatoaLeer);
    }
    ...
    public  void PrincipalDevMediciones() throws IOException, ParseException { // Aplicacion principal para el chequeo de las mediciones
        System.out.println("Inicio de PrincipalDevMediciones de Formato 03 ");
        ...
        String palabraFormato3L1="FECHA_HORA;V_L1;I_L1;V_L2;I_L2;V_L3;I_L3;Wh;VARh;VAh;FP;DMaxW;BANDA_HORARIA";
        ...
        AbsArchivoFormato_03 absArchivo=new AbsArchivoFormato_03(palabraFormato3L1,0,getDirectorio(),tipodeFormatoaLeer,longitudDigitosNombreArchivo) ;// Define el formato a ser leido -->Instancia la clase Archivo e inicializa numerolinea con cero>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><

        System.out.println(" Formato_03 ------------------------>>>> el directorio definido que va a a clase Achivo es "+directorio);
    ...
    public void escribeResultadosenBufferReporte(AbsArchivoFormato_03 absArchivo) throws IOException {
    ...
    public void lazoprincipal2(AbsArchivoFormato_03 absArchivo, String nombreArchivo, int numlineas) throws IOException, ParseException {
        ...
        for (int l=0;l<xlistaArchivos.size();l++) {
            ...
            if ((setup.CnroAplicacionEspecial == 0) && (tipodeFormatoaLeer.equals("FORMATO_03"))) { // no hay caso especial y se habilita el metodo segun FORMATO XX
                System.out.println("<< ESTA ES LA DERIVACION FORMATO 03 ------------------");
                absArchivo.generarTokensFormato_03(path,nombreArchivo,numlineas);
            }
...
// TRATAMIENTO DE CASOS ESPECIALES  en Setup CnroAplicacionEspecial=1 que era san juan
            ...
            listaReporteDetalle.add(" Factor de Potencia:           " + tab()+tab()+ promFP + sbCrLf()); // tomado de promediar valores ver linea 205
            ...
            if(varHabilitaCompilador==1 && suicheCalificacionCompilable==1){
                ...
                System.out.println("fin bucle formato 02");
        }//-----------------------------------------------------------------------------------------------------------------------
