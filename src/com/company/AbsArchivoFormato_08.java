...
import java.util.TimeZone;
    ...
    public class AbsArchivoFormato_08 extends AbsArchivo {

        public AbsArchivoFormato_08(String primeraPalabraValidaArchivo, int anumlineas, String sDirectorioTrabajo, String tipoFormatoaLeer, int numeroTotalDigitosNombreArchivoxtipoFormato) {
        ...
        public String generarTokensFormato_08Monofasico(String path, String nombArch, int numlineas) throws IOException, ParseException {

            System.out.println("generarTokensFormato_08Monofasico");
        ...
        public String generarTokensFormato_08Trifasico(String path, String nombArch, int numlineas) throws IOException, ParseException {
            System.out.println("generarTokensFormato_08Trifasico");
            multiploUnidadPotencia="";
                ...
                while ((blinea = buffer.readLine()) != null) {
                    ...
                    if (indPosicion < lineasEncabezado) {             //valor que delimita la lectura del encabezado
                        ...
                        for (int encb = 0; encb < parts.length; encb++) {
                            ...
                            if ((indPosicion==lineasEncabezado-1) && encb==1 && parts[encb].equals("V") ){
                                // System.out.println(" La linea corresponde a " + indPosicion + "part " + parts[encb]+ " lineaEncabezado= "+lineasEncabezadoArchivoMonofasico+"|"+lineasEncabezado);
                                multiploUnidadPotencia= (parts[8]); // guarda el multiploUnidad de potencia
                                break;
                            }else{
                                if(multiploUnidadPotencia.equals("") && indPosicion==9 && encb>1){// precisa el barrido encb para asegurar que no se cumplio la condicion anterior
                        ...
                        if (blinea.length()>13) {
                            ...
                            // }
                            //*************************************************************************************************
                            if (parts.length > 15) {    // ---- Las siguientes dos lineas alimentan las lista con los flags
